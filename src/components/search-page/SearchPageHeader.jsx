import { Globe, ExternalLink, ChevronDown, Search, UserCircle2 } from "lucide-react";
        ...
        <div className="flex flex-col gap-6 px-4 py-7 sm:px-8 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex items-center gap-4">
            <Link to="/" className="flex items-center gap-3">
              ...
              <button
                ...
                className="text-[22px] font-medium text-sky-700"
              >
                My Jeanluc
              </button>
            </Link>
          ...
          <div className="flex flex-wrap items-center gap-4">
            <button
              ...
              className="inline-flex h-[56px] items-center justify-center rounded-full bg-[#0f4ca1] px-10 text-[18px] font-semibold text-white transition hover:bg-white hover:text-[#0f4ca1] hover:border hover:border-[#0f4ca1]"
            >
              Donate
            </button>
